...
public class AttackPanel extends javax.swing.JPanel {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        mod += g.getAttackTypeModifier(jCheckBox4.getText());

        if (jCheckBox5.isSelected()) {
            mod += g.getModifier("PROF");
        }
        jLabel56.setText(mod + "");
        mod += Formula.getDice(1, 20);
        jLabel52.setText(mod + "");
        if (g.online != null) {
            g.online.print(" rolled ATTACK on " + jTextField7.getText() + " - " + mod);
        }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        jLabel52.setText(mod + "");
        if (g.online != null) {
            g.online.print(" rolled DAMAGE on " + jTextField7.getText() + " - " + mod);
        }
